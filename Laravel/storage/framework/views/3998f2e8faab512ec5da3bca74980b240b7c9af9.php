...
<!-- <select class="w3-select" name="select_event" required>
 ...
 <div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-envelope-o"></i></div>
    <div class="w3-rest">
      <div class="w3-input w3-border w3-gray" ><?php echo e(Auth::user()->email); ?></div>
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-user"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="name" required type="text" value="<?php echo e(Auth::user()->name); ?>" placeholder="Name">
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\Laravel\Laravel\resources\views/momintum/forms/edit_user_info_form.blade.php ENDPATH**/ ?>