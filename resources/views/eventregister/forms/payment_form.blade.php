<form action="/payevtregonline" method="post" class="w3-container w3-card-4 w3-light-grey w3-text-blue-grey w3-margin">
@csrf
...
<label>Please charge my card on file for the Event registration cost in the amount of ${{$event->cost}}.</label><br>
